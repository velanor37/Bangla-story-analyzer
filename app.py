...
# Mistral API এন্ডপয়েন্ট (সঠিক)
MISTRAL_URL = "https://api.mistral.ai/v1/chat/completions"
MODEL_NAME = "mistral-small-latest"  # ফ্রি টিয়ারে কাজ করে
...
<head>
    ...
    <title>পাঠ-পরিচিতি বিশ্লেষক (Mistral AI)</title>
...
<div class="container">
    <header>
        <h1>📚 পাঠ-পরিচিতি বিশ্লেষক (Mistral AI)</h1>
        <p>নির্ভরযোগ্য ও দ্রুত কৃত্রিম বুদ্ধিমত্তা-চালিত সাহিত্য বিশ্লেষণ</p>
    </header>
    <div class="grid">
        <div class="card">
