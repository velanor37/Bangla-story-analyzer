...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    body {
      background: #f2ede4;
      font-family: 'Segoe UI', 'Kalpurush', 'Noto Sans Bengali', Georgia, serif;
      color: #2c1f12;
    }
    ...
    .prose { font-family: 'Noto Sans Bengali', Georgia, serif; }
    .prose h2 { color: #8b3c28; margin-top: 1rem; }
    .error-msg {
      background: #ffe0e0;
      color: #b00020;
      padding: 0.5rem;
...
<script>
  async function generate() {
    ...
    output.innerHTML = '<div class="loading"><div class="spinner"></div><p>গভীর বিশ্লেষণ তৈরি হচ্ছে...</p></div>';
    try {
      ...
      output.innerHTML = '<div class="result-empty">⚠️ সংযোগ সমস্যা, আবার চেষ্টা করুন</div>';
    }
    btn.disabled = false;
